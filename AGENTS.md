...
- **AI co-authorship**: Commits generated by AI assistants must include a co-author trailer identifying the model:
  - DeepSeek v4 Pro: `Co-authored-by: DeepSeek v4 Pro <noreply@deepseek.com>`
  - Other models follow the same pattern: `Name <noreply@provider.tld>`
